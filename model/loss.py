...
from model import pytorch_ssim
...
def structure_loss(pred, mask):
    ...
    #edge_mask = mask - F.avg_pool2d(mask, kernel_size=5, stride=1, padding=2)
    #edge_pred = pred - F.avg_pool2d(pred, kernel_size=5, stride=1, padding=2)
