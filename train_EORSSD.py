...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_epoch', type=int, default=100)#default is 120
    ...
    trainer.train()
# accelerate launch train.py --config config/camoDiffusion_352x352.yaml --num_epoch=150 --batch_size=4 --gradient_accumulate_every=1
#python train.py  --resume models/model-28.pt
